...
import com.example.lab_week_06_76847.model.CatBreed
import com.example.lab_week_06_76847.model.CatModel
import com.example.lab_week_06_76847.model.Gender
...
class CatViewHolder(
    ...
    private val onClickListener: CatAdapter.OnClickListener // pakai listener dari CatAdapter
    ...
    fun bindData(cat: CatModel) {
        containerView.setOnClickListener {
            onClickListener.onItemClick(cat) // panggil dari CatAdapter
        }
